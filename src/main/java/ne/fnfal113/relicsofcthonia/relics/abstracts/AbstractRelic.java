...
public abstract class AbstractRelic extends SlimefunItem implements OffHandRightClickHandler {
    ...
    public void updateRelicLore(){
       ...
       Utils.setLoreByConfigStringList(this.getItem(), this.getId(), "drops-on-material", "掉落在:", "&e", "‣ ", "", "relic-settings");
       // update this itemstack object lore on which mobs do relic drop
       Utils.setLoreByConfigStringList(this.getItem(), this.getId(), "drops-on-mob", "掉落在:", "&e", "‣ ", "", "relic-settings");
       // update this itemstack object lore for the barter rewards
       Utils.setLoreByConfigStringList(this.getItem(), this.getId(), "piglin-barter-rewards", "豬布林可能給予的物品:", "&a", "‣ " + getPiglinRewardAmount() + " ", "", "relic-settings");
    }
